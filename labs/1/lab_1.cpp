 ...
 * Description : Program to ask user for name and if they have any coding experience
 */
...
int main() {
  ...
  cin>>user_name;
  cout<<"You entered: "<<user_name<<endl;

  // (6) Display the mesdirsage "Nice to meet you, NAME" where NAME is replaced
  ...
  cout<<user_name<<", Have you programmed before (y/n)?"<<endl;
